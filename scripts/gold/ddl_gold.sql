...
Script purpose:
  ...
  produce clean, enriched and business-ready data-set.
...
-- ################################################################################
-- Create Dimension: gold.dimention_products
-- ################################################################################
  
IF OBJECT_ID('gold.dimention_products', 'V') IS NOT NULL
    DROP VIEW gold.dimention_products;
GO
